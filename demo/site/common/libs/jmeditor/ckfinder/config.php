...
http://localhost/howdo/howdo/common/libs/jmeditor/ckfinderimages/20140214112417.png
$baseUrl = "http://".$_SERVER["HTTP_HOST"].dirname(dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['SCRIPT_NAME'])))))))."/upload/";
//echo $baseUrl;
